...
namespace ASBDDS.API.Migrations.DataDb
{
    ...
    [Migration("20211129092000_OperationSystemsToBootableImages")]
    partial class OperationSystemsToBootableImages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASBDDS.Shared.Models.Database.DataDb.BootableImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ASBDDS.Shared.Models.Database.DataDb.SharedBootableImageFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("BootableImageId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BootableImageId");

                    b.ToTable("SharedBootableImageFiles");
                });
            ...
            modelBuilder.Entity("ASBDDS.Shared.Models.Database.DataDb.SharedBootableImageFile", b =>
                {
                    b.HasOne("ASBDDS.Shared.Models.Database.DataDb.BootableImage", "BootableImage")
                        .WithMany()
                        .HasForeignKey("BootableImageId");

                    b.Navigation("BootableImage");
                });
